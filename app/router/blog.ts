...
module.exports = (app: Application) => {
  ...
  router.get('/blog/article/loadNewArticle', authentication(app), blog.article.loadNewArticle)//最新文章
  router.get('/blog/article/loadHotArticle', authentication(app), blog.article.loadHotArticle)//最热文章
  ...
  router.get('/blog/article/deleteArticle', authentication(app), blog.article.deleteArticle)//删除
